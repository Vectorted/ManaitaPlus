...
public class ItemManaitaHelmet extends Item {
    public ItemManaitaHelmet(Settings settings) {
        super(settings);

        ItemTooltipCallback.EVENT.register((itemStack, tooltipContext, tooltipType, list) -> {
            if(itemStack.isOf(ManaitaItems.Armor.MANAITA_HELMET)) {
                ...
                list.add(ColorEffectHelper.createRainbowText(Text.translatable("item.vector.manaita_armor_night").getString(), 5.0f, 1, 1.0f, 1.0f, 0.06f));
            }
        });
    }
