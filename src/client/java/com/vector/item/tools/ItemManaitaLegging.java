...
public class ItemManaitaLegging extends Item {
    public ItemManaitaLegging(Settings settings) {
        super(settings);

        ItemTooltipCallback.EVENT.register((itemStack, tooltipContext, tooltipType, list) -> {
            if(itemStack.isOf(ManaitaItems.Armor.MANAITA_LEGGING)) {
                ...
                list.add(ColorEffectHelper.createRainbowText(Text.translatable("item.vector.manaita_armor_disappear").getString(), 5.0f, 1, 1.0f, 1.0f, 0.06f));
            }
        });
    }
